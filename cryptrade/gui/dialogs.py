...
class IndicatorDialog(QtGui.QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.indicatorComboBox.currentIndexChanged.connect(
        ...
        self.buttonBox.addButton(self.add_button,
                                 QtGui.QDialogButtonBox.ActionRole)
        self.buttonBox.addButton(self.done_button,
        ...
        self.indicatorFrame.enableAdd.connect(
            lambda: self.add_button.setEnabled(True))
        self.indicatorFrame.disableAdd.connect(
            lambda: self.add_button.setEnabled(False))
...
class TraderDialog(QtGui.QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.riskInput.setToolTip("As a fraction or percent of total equity, "
                                  "e.g. '0.025' or '2.5%'. This value "
                                  "determines the maximum potential loss per "
                                  "trade, and in conjunction with the "
                                  "stoploss value, the size of each trade.")

        stoplossLabel = QtGui.QLabel('Stoploss price move')
        self.stoplossInput = QtGui.QLineEdit('3%')
        self.stoplossInput.setToolTip("As a fraction or percent of entry "
                                      "price, e.g. '0.03' or '3%'. "
                                      "A stop order will be placed after "
                                      "each trade to exit the position "
        ...
        self.commissionInput.setToolTip("Fraction or percent of each trade "
                                        "lost to exchange commission fees, "
                                        "e.g. '0.002' or '0.2%'.")
    ...
    def resetStrategyFrame(self):
        ...
        self.strategyFrame.disableOk.connect(
            lambda: self.okButton.setEnabled(False))
