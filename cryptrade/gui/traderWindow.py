...
class TraderWindow(QtGui.QWidget):
    ...
    def __init__(self, parent=None, mainWindow=None):
        ...
        self.baseValue.setToolTip('Amount of {} currently held'.format(
                                    self.base.upper()))        
        ...
        self.altValue.setToolTip('Amount of {} currently held'.format(
                                    self.alt.upper()))
    ...
    def setCompletedTrades(self):
        ...
        for trade in trades:
            ...
            self.completedTradesBox.append("{}   {}   {} {}  at  {} {}".format(ut_to_dt(
                trade['timestamp']), trade['type'], trade['amount'], self.trader.base, 
                trade['price'], self.trader.alt))
    ...
    def setOpenOrders(self):
        ...
        for order in self.trader.openOrders:
            self.openOrdersBox.append("{}   {}   {}   {} {}  at  {} {}".format(ut_to_dt(
                    order['timestamp']), order['type'], order['side'], order['original_amount'], 
                    self.trader.base, order['price'], self.trader.alt))
