...
from utilities import parse_period, pdelta, ut_to_dt
...
class CandlePlot(Figure):
    ...
    def __init__(self, parent=None):
        ...
        super(CandlePlot, self).__init__(figsize=(12, 8),
        ...
        self.ax2 = self.add_subplot(gs[-1, :], sharex=self.ax1,
                                    axisbg=self.theme['axisbg'])

        self.subplots_adjust(left=0.06, right=0.97, bottom=0.05,
                             top=0.94, hspace=0)
