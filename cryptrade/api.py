...
class BitfinexAPI(object):
    ...
    def ticker(self, symbol="btcusd"):
        ...
        return self.tryAPIcall(lambda: requests.get("https://"+self.BITFINEX+"/v1/ticker/"+symbol, verify=False, timeout=TIMEOUT))
    ...
    def today(self, symbol="btcusd"):
        ...
        Response:
            ...
            high (price)
            volume (price)"""
        return self.tryAPIcall(lambda: requests.get("https://"+self.BITFINEX+"/v1/today/"+symbol, verify=False, timeout=TIMEOUT))
    ...
    def candles(self, payload, symbol="btcusd"):
        ...
        return self.tryAPIcall(lambda: requests.get("https://"+self.BITFINEX+"/v1/candles/"+symbol, headers=headers, verify=False, timeout=TIMEOUT))
    ...
    def lendbook(self, payload, symbol="btcusd"):
        ...
        Response:
            ...
            timestamp (time)"""
        headers = self._prepare_payload(False, payload)
        return self.tryAPIcall(lambda: requests.get("https://"+self.BITFINEX+"/v1/lendbook/"+symbol, headers=headers, verify=False, timeout=TIMEOUT))
    ...
    def book(self, payload, symbol="btcusd"):
        ...
        Example:
            {u'bids': 
                [{u'timestamp': Decimal('1389375876.0'), u'price': Decimal('830.0'), u'amount': Decimal('0.71413304')}, 
                 {u'timestamp': Decimal('1389375863.0'), u'price': Decimal('829.0'), u'amount': Decimal('1.0')}, 
                 {u'timestamp': Decimal('1389376067.0'), u'price': Decimal('829.0'), u'amount': Decimal('2.0')}, 
                 {u'timestamp': Decimal('1389376072.0'), u'price': Decimal('828.01'), u'amount': Decimal('0.81391621')}, 
                 {u'timestamp': Decimal('1389375637.0'), u'price': Decimal('828.0'), u'amount': Decimal('1.0')}], 
             u'asks': 
                 [{u'timestamp': Decimal('1389376082.0'), u'price': Decimal('831.0'), u'amount': Decimal('0.74827024')}, 
                  {u'timestamp': Decimal('1389376064.0'), u'price': Decimal('831.01'), u'amount': Decimal('4.08318334')}, 
                  {u'timestamp': Decimal('1389376090.0'), u'price': Decimal('831.01'), u'amount': Decimal('0.4')}, 
                  {u'timestamp': Decimal('1389376089.0'), u'price': Decimal('832.8799'), u'amount': Decimal('1.35')}, 
                  {u'timestamp': Decimal('1389376082.0'), u'price': Decimal('832.88'), u'amount': Decimal('0.83139194')}]
            }"""
        headers = self._prepare_payload(False, payload)
        return self.tryAPIcall(lambda: requests.get("https://"+self.BITFINEX+"/v1/book/"+symbol, headers=headers, verify=False, timeout=TIMEOUT))
    ...
    def trades(self, payload, symbol="btcusd"):
        ...
        Response:
            ...
            exchange (string)"""
        headers = self._prepare_payload(False, payload)
        return self.tryAPIcall(lambda: requests.get("https://"+self.BITFINEX+"/v1/trades/"+symbol, headers=headers, verify=False, timeout=TIMEOUT))
    ...
    def lends(self, payload, symbol="btcusd"):
        ...
        Response:
            ...
            timestamp (time)"""
        headers = self._prepare_payload(False, payload)
        return self.tryAPIcall(lambda: requests.get("https://"+self.BITFINEX+"/v1/lends/"+symbol, headers=headers, verify=False, timeout=TIMEOUT))
    ...
    def symbols(self):
        ...
        return self.tryAPIcall(lambda: requests.get("https://"+self.BITFINEX+"/v1/symbols", verify=False))
...
### AUTHENTICATED ###
    def order_new(self, payload):
        ...
        return self.tryAPIcall(lambda: requests.post("https://"+self.BITFINEX+"/v1/order/new", headers=headers, verify=False, timeout=TIMEOUT))
    ...
    def order_cancel(self, payload):
        ...
        payload["nonce"] = str(long(time.time() * 100000))
        headers = self._prepare_payload(True, payload)
        return self.tryAPIcall(lambda: requests.post("https://"+self.BITFINEX+"/v1/order/cancel", headers=headers, verify=False, timeout=TIMEOUT))
    ...
    def order_status(self, payload):
        ...
        payload["nonce"] = str(long(time.time() * 100000))
        headers = self._prepare_payload(True, payload)
        return self.tryAPIcall(lambda: requests.get("https://"+self.BITFINEX+"/v1/order/status", headers=headers, verify=False, timeout=TIMEOUT))
    ...
    def orders(self):
        ...
        payload["nonce"] = str(long(time.time() * 100000))
        headers = self._prepare_payload(True, payload)
        return self.tryAPIcall(lambda: requests.get("https://"+self.BITFINEX+"/v1/orders", headers=headers, verify=False, timeout=TIMEOUT))
    ...
    def positions(self):
        ...
        payload["nonce"] = str(long(time.time() * 100000))
        headers = self._prepare_payload(True, payload)
        return self.tryAPIcall(lambda: requests.get("https://"+self.BITFINEX+"/v1/positions", headers=headers, verify=False, timeout=TIMEOUT))
    ...
    def balances(self):
        ...
        Example response:
        [{u'available': Decimal('0.0'), u'currency': u'btc', u'amount': Decimal('0.0'), u'type': u'trading'}, 
         {u'available': Decimal('0.0'), u'currency': u'usd', u'amount': Decimal('0.0'), u'type': u'trading'}, 
          
         {u'available': Decimal('0.0'), u'currency': u'btc', u'amount': Decimal('0.0'), u'type': u'deposit'}, 
         {u'available': Decimal('0.0'), u'currency': u'usd', u'amount': Decimal('0.0'), u'type': u'deposit'}, 
          
         {u'available': Decimal('0.0'),          u'currency': u'btc', u'amount': Decimal('0.0'),          u'type': u'exchange'}, 
         {u'available': Decimal('481.24270344'), u'currency': u'usd', u'amount': Decimal('481.24270344'), u'type': u'exchange'}]                
                """        
        ...
        payload["nonce"] = str(long(time.time() * 100000))
        headers = self._prepare_payload(True, payload)
        return self.tryAPIcall(lambda: requests.get("https://"+self.BITFINEX+"/v1/balances", headers=headers, verify=False, timeout=TIMEOUT))
    ...
    def past_trades(self, payload):
        ...
        payload["nonce"] = str(long(time.time() * 100000))
        headers = self._prepare_payload(True, payload)
        return self.tryAPIcall(lambda: requests.post("https://"+self.BITFINEX+"/v1/mytrades", headers=headers, verify=False, timeout=TIMEOUT))
